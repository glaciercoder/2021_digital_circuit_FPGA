...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net AN0_1 [get_bd_ports AN0] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net AN1_1 [get_bd_ports AN1] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net AN2_1 [get_bd_ports AN2] [get_bd_pins xup_inv_3/a]
  ...
  connect_bd_net -net xup_inv_2_y [get_bd_pins xup_and2_3/a] [get_bd_pins xup_inv_2/y]
  connect_bd_net -net xup_inv_3_y [get_bd_pins xup_and2_2/a] [get_bd_pins xup_inv_3/y]
