...
proc create_root_design { parentCell } {
  ...
  # Create instance: Adder_1_5, and set properties
  set Adder_1_5 [ create_bd_cell -type ip -vlnv xilinx.com:user:Adder_1:1.0 Adder_1_5 ]
  ...
  connect_bd_net -net Adder_1_3_CO [get_bd_pins Adder_1_3/CO] [get_bd_pins Adder_1_4/CI]
  connect_bd_net -net Adder_1_3_S [get_bd_ports S3] [get_bd_pins Adder_1_3/S]
  connect_bd_net -net Adder_1_4_CO [get_bd_pins Adder_1_4/CO] [get_bd_pins Adder_1_5/CI]
  connect_bd_net -net Adder_1_4_S [get_bd_ports S4] [get_bd_pins Adder_1_4/S]
  connect_bd_net -net Adder_1_5_CO [get_bd_ports CO] [get_bd_pins Adder_1_5/CO]
  connect_bd_net -net Adder_1_5_S [get_bd_ports S5] [get_bd_pins Adder_1_5/S]
  connect_bd_net -net CI_1 [get_bd_ports CI] [get_bd_pins Adder_1_1/CI]
  ...
  connect_bd_net -net a4_1 [get_bd_ports a4] [get_bd_pins Adder_1_4/a]
  connect_bd_net -net a5_1 [get_bd_ports a5] [get_bd_pins Adder_1_5/a]
  ...
  connect_bd_net -net b4_1 [get_bd_ports b4] [get_bd_pins Adder_1_4/b]
  connect_bd_net -net b5_1 [get_bd_ports b5] [get_bd_pins Adder_1_5/b]
