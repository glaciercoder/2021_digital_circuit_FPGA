...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net decimal_counter_0_qa [get_bd_pins decimal_counter_0/cp2_n] [get_bd_pins decimal_counter_0/qa] [get_bd_pins decimal_counter_1/cp1_n] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_and2_2/a] [get_bd_pins xup_inv_0/a] [get_bd_pins xup_nor2_0/a]
  connect_bd_net -net decimal_counter_1_qa [get_bd_pins decimal_counter_1/cp2_n] [get_bd_pins decimal_counter_1/qa] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_and2_2/b] [get_bd_pins xup_inv_1/a] [get_bd_pins xup_nor2_0/b]
  connect_bd_net -net xup_and2_0_y [get_bd_pins xup_and2_0/y] [get_bd_pins xup_inv_4/a]
  connect_bd_net -net xup_and2_1_y [get_bd_pins xup_and2_1/y] [get_bd_pins xup_inv_5/a]
  ...
  connect_bd_net -net xup_inv_2_y [get_bd_ports AN3] [get_bd_pins xup_inv_2/y]
  connect_bd_net -net xup_inv_3_y [get_bd_ports AN0] [get_bd_pins xup_inv_3/y]
  connect_bd_net -net xup_inv_4_y [get_bd_ports AN1] [get_bd_pins xup_inv_4/y]
  connect_bd_net -net xup_inv_5_y [get_bd_ports AN2] [get_bd_pins xup_inv_5/y]
  connect_bd_net -net xup_nor2_0_y [get_bd_pins xup_inv_3/a] [get_bd_pins xup_nor2_0/y]
