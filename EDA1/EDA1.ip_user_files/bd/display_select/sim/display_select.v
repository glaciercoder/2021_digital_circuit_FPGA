...
module display_select
  ...
  assign a3_1 = a3;
  assign a4_1 = a4;
  display_select_xup_and2_0_5 xup_and2_0
       (.a(xup_inv_0_y),
        .b(a1_1),
        .y(xup_and2_0_y));
  ...
  display_select_xup_and2_2_1 xup_and2_2
       (.a(xup_inv_3_y),
        .b(a3_1),
        .y(xup_and2_2_y));
  display_select_xup_and2_3_1 xup_and2_3
       (.a(xup_inv_2_y),
        .b(a4_1),
        .y(xup_and2_3_y));
  display_select_xup_inv_0_5 xup_inv_0
       (.a(AN0_1),
        .y(xup_inv_0_y));
  ...
  display_select_xup_inv_2_1 xup_inv_2
       (.a(AN3_1),
        .y(xup_inv_2_y));
  display_select_xup_inv_3_1 xup_inv_3
       (.a(AN2_1),
        .y(xup_inv_3_y));
  display_select_xup_or4_0_2 xup_or4_0
       (.a(xup_and2_0_y),
        .b(xup_and2_1_y),
        .c(xup_and2_2_y),
        .d(xup_and2_3_y),
