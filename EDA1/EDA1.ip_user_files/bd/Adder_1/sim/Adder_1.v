...
module Adder_1
  ...
  assign a_1 = a;
  assign b_1 = b;
  Adder_1_xup_nor2_0_4 xup_nor2_0
       (.a(CI_1),
        .b(b_1),
        .y(xup_nor2_0_y));
  Adder_1_xup_nor2_2_0 xup_nor2_2
       (.a(a_1),
        .b(CI_1),
        .y(xup_nor2_2_y));
  Adder_1_xup_nor2_3_0 xup_nor2_3
       (.a(a_1),
        .b(b_1),
        .y(xup_nor2_3_y));
  Adder_1_xup_nor3_0_1 xup_nor3_0
       (.a(xup_nor2_0_y),
        .b(xup_nor2_2_y),
        .c(xup_nor2_3_y),
        .y(xup_nor3_0_y));
  Adder_1_xup_xor2_0_2 xup_xor2_0
       (.a(a_1),
        .b(b_1),
        .y(xup_xor2_0_y));
  Adder_1_xup_xor2_1_0 xup_xor2_1
       (.a(xup_xor2_0_y),
        .b(CI_1),
        .y(xup_xor2_1_y));
endmodule
