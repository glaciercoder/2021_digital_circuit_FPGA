...
#
# Generated by export_simulation on Sat Nov 20 14:12:43 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './input_5_complementor.sh' script.

./input_5_complementor.sh -reset_run
...
./input_5_complementor.sh -noclean_files

For more information on the script, please type './input_5_complementor.sh -help'.
