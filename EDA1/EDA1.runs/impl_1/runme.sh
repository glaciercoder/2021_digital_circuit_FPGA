...
HD_PWD='C:/Users/weibc/Desktop/EDA1/EDA1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Calculator_total_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Calculator_total_wrapper.tcl -notrace
