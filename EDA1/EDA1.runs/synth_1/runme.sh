...
HD_PWD='C:/Users/weibc/Desktop/EDA1/EDA1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Calculator_total_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Calculator_total_wrapper.tcl
