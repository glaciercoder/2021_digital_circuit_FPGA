...
################################################################
# This is a generated script based on design: display_select
#
...
# source display_select_script.tcl
...
set design_name display_select
...
proc create_root_design { parentCell } {
  ...
  set AN4 [ create_bd_port -dir I AN4 ]
  ...
  connect_bd_net -net AN2_1 [get_bd_ports AN2] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net AN3_1 [get_bd_ports AN3] [get_bd_pins xup_inv_2/a]
  connect_bd_net -net AN4_1 [get_bd_ports AN4] [get_bd_pins xup_inv_3/a]
  connect_bd_net -net AN_1 [get_bd_ports AN1] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net a1_1 [get_bd_ports a1] [get_bd_pins xup_and2_0/b]
  connect_bd_net -net a2_1 [get_bd_ports a2] [get_bd_pins xup_and2_1/b]
  connect_bd_net -net a3_1 [get_bd_ports a3] [get_bd_pins xup_and2_2/b]
  connect_bd_net -net a4_1 [get_bd_ports a4] [get_bd_pins xup_and2_3/b]
  ...
  connect_bd_net -net xup_and2_3_y [get_bd_pins xup_and2_3/y] [get_bd_pins xup_or4_0/d]
  ...
  connect_bd_net -net xup_inv_2_y [get_bd_pins xup_and2_2/a] [get_bd_pins xup_inv_2/y]
  connect_bd_net -net xup_inv_3_y [get_bd_pins xup_and2_3/a] [get_bd_pins xup_inv_3/y]
  connect_bd_net -net xup_or4_0_y [get_bd_ports a] [get_bd_pins xup_or4_0/y]
