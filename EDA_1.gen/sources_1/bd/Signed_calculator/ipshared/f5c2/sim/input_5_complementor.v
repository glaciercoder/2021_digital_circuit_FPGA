...
module input_5_complementor
  ...
  input_5_complementor_Adder_1_0_1 Adder_1_1
       (.CI(GND_1),
        ...
        .a(Adder_1_0_CO),
        .b(xup_xor2_1_y));
  input_5_complementor_Adder_1_0_2 Adder_1_2
       (.CI(GND_1),
        .CO(Adder_1_2_CO),
        .S(Adder_1_2_S),
        .a(Adder_1_1_CO),
        .b(xup_xor2_3_y));
  input_5_complementor_Adder_1_0_3 Adder_1_3
       (.CI(GND_1),
        .CO(Adder_1_3_CO),
        .S(Adder_1_3_S),
        .a(Adder_1_4_CO),
        .b(xup_xor2_4_y));
  input_5_complementor_Adder_1_2_0 Adder_1_4
       (.CI(GND_1),
        .CO(Adder_1_4_CO),
        .S(Adder_1_4_S),
        .a(Adder_1_2_CO),
