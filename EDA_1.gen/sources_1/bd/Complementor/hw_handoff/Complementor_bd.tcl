...
################################################################
# This is a generated script based on design: Complementor
#
...
# source Complementor_script.tcl
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net GND_1 [get_bd_ports GND] [get_bd_pins Adder_1_0/CI] [get_bd_pins Adder_1_1/CI] [get_bd_pins Adder_1_2/CI] [get_bd_pins Adder_1_3/CI] [get_bd_pins xup_xor2_3/a]
  connect_bd_net -net Sign_1 [get_bd_ports Sign] [get_bd_pins Adder_1_0/a] [get_bd_pins xup_xor2_0/a] [get_bd_pins xup_xor2_1/a] [get_bd_pins xup_xor2_2/a] [get_bd_pins xup_xor2_3/b]
  ...
  connect_bd_net -net a3_1 [get_bd_ports a3] [get_bd_pins xup_xor2_2/b]
  connect_bd_net -net xup_xor2_0_y [get_bd_pins Adder_1_0/b] [get_bd_pins xup_xor2_0/y]
  connect_bd_net -net xup_xor2_1_y [get_bd_pins Adder_1_1/b] [get_bd_pins xup_xor2_1/y]
  connect_bd_net -net xup_xor2_2_y [get_bd_pins Adder_1_2/b] [get_bd_pins xup_xor2_2/y]
  connect_bd_net -net xup_xor2_3_y [get_bd_pins Adder_1_3/b] [get_bd_pins xup_xor2_3/y]
