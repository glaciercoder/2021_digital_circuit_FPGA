...
(* CORE_GENERATION_INFO = "frequency_divider,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=frequency_divider,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "frequency_divider.hwdef" *) 
module frequency_divider
  ...
  frequency_divider_decimal_counter_0_0 decimal_counter_0
       (.cp1_n(CLK_1),
        ...
        .r9_1(GND_1),
        .r9_2(GND_1));
  frequency_divider_xup_nor4_0_0 xup_nor4_0
