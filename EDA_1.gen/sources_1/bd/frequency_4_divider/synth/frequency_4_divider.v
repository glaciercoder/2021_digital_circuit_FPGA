...
(* CORE_GENERATION_INFO = "frequency_4_divider,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=frequency_4_divider,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "frequency_4_divider.hwdef" *) 
module frequency_4_divider
  ...
  assign AN0 = xup_nor2_0_y;
  assign AN1 = xup_and2_1_y;
  assign AN2 = xup_and2_0_y;
  assign AN3 = xup_and2_2_y;
  assign CLK_1 = CLK;
  assign GND_1 = GND;
  frequency_4_divider_decimal_counter_0_3 decimal_counter_0
       (.cp1_n(CLK_1),
  ...
  frequency_4_divider_xup_and2_0_3 xup_and2_0
       (.a(xup_inv_0_y),
        ...
        .y(xup_and2_0_y));
  frequency_4_divider_xup_and2_1_2 xup_and2_1
       (.a(decimal_counter_0_qa),
        .b(xup_inv_1_y),
        .y(xup_and2_1_y));
  frequency_4_divider_xup_and2_2_1 xup_and2_2
       (.a(decimal_counter_0_qa),
        .b(decimal_counter_1_qa),
        .y(xup_and2_2_y));
  frequency_4_divider_xup_inv_0_3 xup_inv_0
       (.a(decimal_counter_0_qa),
        .y(xup_inv_0_y));
  frequency_4_divider_xup_inv_1_1 xup_inv_1
       (.a(decimal_counter_1_qa),
        .y(xup_inv_1_y));
  frequency_4_divider_xup_nor2_0_2 xup_nor2_0
       (.a(decimal_counter_0_qa),
        .b(decimal_counter_1_qa),
        .y(xup_nor2_0_y));
endmodule
