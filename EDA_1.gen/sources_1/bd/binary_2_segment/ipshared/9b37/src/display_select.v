...
module display_select
  ...
  display_select_xup_and2_0_1 xup_and2_1
       (.a(xup_inv_1_y),
        .b(a2_1),
        .y(xup_and2_1_y));
  display_select_xup_and2_1_0 xup_and2_2
       (.a(xup_inv_2_y),
        .b(a3_1),
        .y(xup_and2_2_y));
  display_select_xup_and2_2_0 xup_and2_3
       (.a(xup_inv_3_y),
        .b(a4_1),
        .y(xup_and2_3_y));
  ...
  display_select_xup_inv_0_1 xup_inv_1
       (.a(AN2_1),
        .y(xup_inv_1_y));
  display_select_xup_inv_1_0 xup_inv_2
       (.a(AN3_1),
        .y(xup_inv_2_y));
  display_select_xup_inv_2_0 xup_inv_3
       (.a(AN4_1),
        .y(xup_inv_3_y));
