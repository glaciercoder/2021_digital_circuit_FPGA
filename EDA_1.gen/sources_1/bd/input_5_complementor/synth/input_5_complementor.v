...
module input_5_complementor
  ...
  assign a4_1 = a4;
  assign a5_1 = a5;
  input_5_complementor_Adder_1_0_4 Adder_1_0
       (.CI(GND_1),
        .CO(Adder_1_0_CO),
        .S(Adder_1_0_S),
        .a(xup_xor2_0_y),
        .b(Sign_1));
  input_5_complementor_Adder_1_1_0 Adder_1_1
       (.CI(GND_1),
        .CO(Adder_1_1_CO),
        .S(Adder_1_1_S),
        .a(Adder_1_0_CO),
        .b(xup_xor2_1_y));
  input_5_complementor_Adder_1_2_1 Adder_1_2
       (.CI(GND_1),
        .CO(Adder_1_2_CO),
        .S(Adder_1_2_S),
        .a(Adder_1_1_CO),
        .b(xup_xor2_3_y));
  input_5_complementor_Adder_1_3_0 Adder_1_3
       (.CI(GND_1),
        .CO(Adder_1_3_CO),
        .S(Adder_1_3_S),
        .a(Adder_1_4_CO),
        .b(xup_xor2_4_y));
  input_5_complementor_Adder_1_4_0 Adder_1_4
       (.CI(GND_1),
        .CO(Adder_1_4_CO),
        .S(Adder_1_4_S),
        .a(Adder_1_2_CO),
        .b(xup_xor2_2_y));
  input_5_complementor_xup_xor2_0_5 xup_xor2_0
       (.a(Sign_1),
        .b(a1_1),
        .y(xup_xor2_0_y));
  input_5_complementor_xup_xor2_1_0 xup_xor2_1
       (.a(Sign_1),
        .b(a2_1),
        .y(xup_xor2_1_y));
  input_5_complementor_xup_xor2_2_0 xup_xor2_2
       (.a(Sign_1),
        .b(a4_1),
        .y(xup_xor2_2_y));
  input_5_complementor_xup_xor2_3_0 xup_xor2_3
       (.a(Sign_1),
        .b(a3_1),
        .y(xup_xor2_3_y));
  input_5_complementor_xup_xor2_4_0 xup_xor2_4
       (.a(Sign_1),
        .b(a5_1),
        .y(xup_xor2_4_y));
endmodule
