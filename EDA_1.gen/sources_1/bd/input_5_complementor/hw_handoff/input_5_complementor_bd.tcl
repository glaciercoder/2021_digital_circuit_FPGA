...
################################################################
# This is a generated script based on design: input_5_complementor
#
...
# source input_5_complementor_script.tcl
...
set design_name input_5_complementor
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Adder_1_4, and set properties
  set Adder_1_4 [ create_bd_cell -type ip -vlnv xilinx.com:user:Adder_1:1.0 Adder_1_4 ]
  ...
  connect_bd_net -net Adder_1_0_CO [get_bd_pins Adder_1_0/CO] [get_bd_pins Adder_1_1/a]
  connect_bd_net -net Adder_1_0_S [get_bd_ports S1] [get_bd_pins Adder_1_0/S]
  connect_bd_net -net Adder_1_1_CO [get_bd_pins Adder_1_1/CO] [get_bd_pins Adder_1_2/a]
  connect_bd_net -net Adder_1_1_S [get_bd_ports S2] [get_bd_pins Adder_1_1/S]
  connect_bd_net -net Adder_1_2_CO [get_bd_pins Adder_1_2/CO] [get_bd_pins Adder_1_4/a]
  ...
  connect_bd_net -net Adder_1_3_S [get_bd_ports S5] [get_bd_pins Adder_1_3/S]
  connect_bd_net -net Adder_1_4_CO [get_bd_pins Adder_1_3/a] [get_bd_pins Adder_1_4/CO]
  connect_bd_net -net Adder_1_4_S [get_bd_ports S4] [get_bd_pins Adder_1_4/S]
  connect_bd_net -net GND_1 [get_bd_ports GND] [get_bd_pins Adder_1_0/CI] [get_bd_pins Adder_1_1/CI] [get_bd_pins Adder_1_2/CI] [get_bd_pins Adder_1_3/CI] [get_bd_pins Adder_1_4/CI]
  connect_bd_net -net Sign_1 [get_bd_ports Sign] [get_bd_pins Adder_1_0/b] [get_bd_pins xup_xor2_0/a] [get_bd_pins xup_xor2_1/a] [get_bd_pins xup_xor2_2/a] [get_bd_pins xup_xor2_3/a] [get_bd_pins xup_xor2_4/a]
  connect_bd_net -net a1_1 [get_bd_ports a1] [get_bd_pins xup_xor2_0/b]
  connect_bd_net -net a2_1 [get_bd_ports a2] [get_bd_pins xup_xor2_1/b]
  connect_bd_net -net a3_1 [get_bd_ports a3] [get_bd_pins xup_xor2_3/b]
  connect_bd_net -net a4_1 [get_bd_ports a4] [get_bd_pins xup_xor2_2/b]
  connect_bd_net -net a5_1 [get_bd_ports a5] [get_bd_pins xup_xor2_4/b]
  connect_bd_net -net xup_xor2_0_y [get_bd_pins Adder_1_0/a] [get_bd_pins xup_xor2_0/y]
  connect_bd_net -net xup_xor2_1_y [get_bd_pins Adder_1_1/b] [get_bd_pins xup_xor2_1/y]
  connect_bd_net -net xup_xor2_2_y [get_bd_pins Adder_1_4/b] [get_bd_pins xup_xor2_2/y]
  connect_bd_net -net xup_xor2_3_y [get_bd_pins Adder_1_2/b] [get_bd_pins xup_xor2_3/y]
  connect_bd_net -net xup_xor2_4_y [get_bd_pins Adder_1_3/b] [get_bd_pins xup_xor2_4/y]
