...
module Adder_1
  ...
  assign b_1 = b;
  assign c_1 = CI;
  Adder_1_xup_nor2_0_9 xup_nor2_0
       (.a(a_1),
        .b(c_1),
        .y(xup_nor2_0_y));
  Adder_1_xup_nor2_1_6 xup_nor2_1
       (.a(a_1),
        .b(b_1),
        .y(xup_nor2_1_y));
  Adder_1_xup_nor2_2_6 xup_nor2_2
       (.a(b_1),
        .b(c_1),
        .y(xup_nor2_2_y));
  Adder_1_xup_nor3_0_7 xup_nor3_0
       (.a(xup_nor2_1_y),
        .b(xup_nor2_0_y),
        .c(xup_nor2_2_y),
        .y(xup_nor3_0_y));
  Adder_1_xup_xor2_0_8 xup_xor2_0
       (.a(a_1),
        .b(b_1),
        .y(xup_xor2_0_y));
  Adder_1_xup_xor2_1_6 xup_xor2_1
       (.a(xup_xor2_0_y),
        .b(c_1),
        .y(xup_xor2_1_y));
endmodule
