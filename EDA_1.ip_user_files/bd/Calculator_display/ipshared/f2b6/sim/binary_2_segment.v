...
module binary_2_segment
  ...
  binary_2_segment_BCD2SEG7_0_0 BCD2SEG7_0
       (.BCD_A(S1_1),
        .BCD_B(xup_or2_2_y),
        .BCD_C(xup_or2_1_y),
        .BCD_D(xup_and3_0_y),
        ...
        .f(BCD2SEG7_0_f),
        .g(BCD2SEG7_0_g));
  binary_2_segment_BCD2SEG7_0_1 BCD2SEG7_1
       (.BCD_A(xup_or2_0_y),
        .BCD_B(GND_1),
        .BCD_C(GND_1),
        .BCD_D(GND_1),
        ...
        .f(BCD2SEG7_1_f),
        .g(BCD2SEG7_1_g));
  binary_2_segment_BCD2SEG7_1_0 BCD2SEG7_2
       (.BCD_A(a1_1),
        .BCD_B(a2_1),
        .BCD_C(a3_1),
        .BCD_D(GND_1),
        ...
        .f(BCD2SEG7_2_f),
        .g(BCD2SEG7_2_g));
  binary_2_segment_BCD2SEG7_2_0 BCD2SEG7_3
       (.BCD_A(b1_1),
        .BCD_B(b2_1),
        .BCD_C(b3_1),
        .BCD_D(GND_1),
        ...
        .f(BCD2SEG7_3_f),
        .g(BCD2SEG7_3_g));
  binary_2_segment_display_select_0_0 display_select_0
       (.AN1(Net),
        .AN2(Net1),
        .AN3(Net2),
        .AN4(Net3),
        ...
        .a3(BCD2SEG7_1_a),
        .a4(BCD2SEG7_0_a));
  binary_2_segment_display_select_0_1 display_select_1
       (.AN1(Net),
        .AN2(Net1),
        .AN3(Net2),
        .AN4(Net3),
        ...
        .a3(BCD2SEG7_1_b),
        .a4(BCD2SEG7_0_b));
  binary_2_segment_display_select_0_2 display_select_2
       (.AN1(Net),
        .AN2(Net1),
        .AN3(Net2),
        .AN4(Net3),
        ...
        .a3(BCD2SEG7_1_c),
        .a4(BCD2SEG7_0_c));
  binary_2_segment_display_select_2_0 display_select_3
       (.AN1(Net),
        .AN2(Net1),
        .AN3(Net2),
        .AN4(Net3),
        ...
        .a3(BCD2SEG7_1_d),
        .a4(BCD2SEG7_0_d));
  binary_2_segment_display_select_4_1 display_select_4
       (.AN1(Net),
        .AN2(Net1),
        .AN3(Net2),
        .AN4(Net3),
        ...
        .a3(BCD2SEG7_1_e),
        .a4(BCD2SEG7_0_e));
  binary_2_segment_display_select_4_0 display_select_5
       (.AN1(Net),
        .AN2(Net1),
        .AN3(Net2),
        .AN4(Net3),
        ...
        .a3(BCD2SEG7_1_f),
        .a4(BCD2SEG7_0_f));
  binary_2_segment_display_select_5_0 display_select_6
       (.AN1(Net),
        .AN2(Net1),
        .AN3(Net2),
        .AN4(Net3),
  ...
  binary_2_segment_xup_and2_0_2 xup_and2_0
       (.a(S4_1),
        .b(S3_1),
        .y(xup_and2_0_y));
  binary_2_segment_xup_and2_0_3 xup_and2_1
       (.a(S4_1),
        .b(S2_1),
        .y(xup_and2_1_y));
  binary_2_segment_xup_and2_0_4 xup_and2_2
       (.a(xup_inv_0_y),
        .b(S3_1),
        .y(xup_and2_2_y));
  binary_2_segment_xup_and2_0_5 xup_and2_3
       (.a(S3_1),
        .b(S2_1),
        .y(xup_and2_3_y));
  binary_2_segment_xup_and2_3_0 xup_and2_4
       (.a(xup_inv_0_y),
        .b(S2_1),
        .y(xup_and2_4_y));
  binary_2_segment_xup_and3_0_1 xup_and3_0
       (.a(S4_1),
        .b(xup_inv_1_y),
        .c(xup_inv_2_y),
        .y(xup_and3_0_y));
  binary_2_segment_xup_and3_0_2 xup_and3_1
       (.a(S4_1),
        .b(S3_1),
        .c(xup_inv_2_y),
        .y(xup_and3_1_y));
  binary_2_segment_xup_inv_0_3 xup_inv_0
       (.a(S4_1),
        .y(xup_inv_0_y));
  binary_2_segment_xup_inv_0_4 xup_inv_1
       (.a(S3_1),
        .y(xup_inv_1_y));
  binary_2_segment_xup_inv_0_5 xup_inv_2
       (.a(S2_1),
        .y(xup_inv_2_y));
  binary_2_segment_xup_or2_0_1 xup_or2_0
       (.a(xup_and2_0_y),
        .b(xup_and2_1_y),
        .y(xup_or2_0_y));
  binary_2_segment_xup_or2_0_2 xup_or2_1
       (.a(xup_and2_2_y),
        .b(xup_and2_3_y),
        .y(xup_or2_1_y));
  binary_2_segment_xup_or2_1_0 xup_or2_2
       (.a(xup_and3_1_y),
        .b(xup_and2_4_y),
        .y(xup_or2_2_y));
endmodule
