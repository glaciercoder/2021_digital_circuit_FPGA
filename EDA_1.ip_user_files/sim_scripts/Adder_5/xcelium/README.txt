...
#
# Generated by export_simulation on Tue Nov 16 21:47:05 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './Adder_5.sh' script.

./Adder_5.sh -reset_run
...
./Adder_5.sh -noclean_files

For more information on the script, please type './Adder_5.sh -help'.
