...
#
# Generated by export_simulation on Tue Nov 16 21:47:13 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './Adder_4.sh' script.

./Adder_4.sh -reset_run
...
./Adder_4.sh -noclean_files

For more information on the script, please type './Adder_4.sh -help'.
