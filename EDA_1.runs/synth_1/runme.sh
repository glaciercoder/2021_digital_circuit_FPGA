...
HD_PWD='C:/Users/weibc/Desktop/EDA_1/EDA_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder_1_wrapper.tcl
