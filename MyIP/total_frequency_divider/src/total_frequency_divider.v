...
module total_frequency_divider
  ...
  assign CLK_1 = CLK;
  assign GND_1 = GND;
  total_frequency_divider_frequency_4_divider_0_2 frequency_4_divider_0
       (.AN0(frequency_4_divider_0_AN0),
        ...
        .GND(GND_1));
  total_frequency_divider_frequency_divider_0_4 frequency_divider_0
       (.CLK(CLK_1),
        .GND(GND_1),
        .y(frequency_divider_0_y));
  total_frequency_divider_frequency_divider_1_0 frequency_divider_1
       (.CLK(frequency_divider_0_y),
        .GND(GND_1),
        .y(frequency_divider_1_y));
  total_frequency_divider_frequency_divider_2_1 frequency_divider_2
       (.CLK(frequency_divider_1_y),
        .GND(GND_1),
        .y(frequency_divider_2_y));
  total_frequency_divider_frequency_divider_3_0 frequency_divider_3
       (.CLK(frequency_divider_2_y),
        .GND(GND_1),
        .y(frequency_divider_3_y));
  total_frequency_divider_frequency_divider_4_1 frequency_divider_4
